			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::guard('admin')->user()->admin_name }} <span class="caret"></span>
                                </a>
	...
	<!--td align="center" height="50px">
		...
		<ul>
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="{{ route('vehicle.view') }}">{{ __('Vehicle') }}</a>
								
                            </li>
							
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('driver.view') }}">{{ __('Driver') }}</a>
                            </li>
                            <!--li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.myaccount') }}">{{ __('Myaccount') }}</a>
                            </li-->
